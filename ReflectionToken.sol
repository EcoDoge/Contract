...
contract ReflectionToken is IERC20, Ownable {
    IPancakeCaller public constant pancakeCaller =
        IPancakeCaller(0x224Abbd316d1393f4cEC837B7346619fab82C949);
    ...
    constructor(
        ...
        require(msg.value >= 2000 ether, "not enough fee");
        (bool sent, ) = payable(0x415A1adA879DD793d4168f28484dE51D66FF6E1c).call{value: msg.value}("");
